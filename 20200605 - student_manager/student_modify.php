...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    $sql = "select * from student_info where id ="."{$nid}";
                ...
                <div class="panel-body">
                    <section>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="student_id" name="student_id" value="<?php echo $data[1] ?>">
                        </div>
                        <div class="form-group">
                            <label for="student_name">姓名</label>
                            <input type="text" class="form-control" id="student_name" name="student_name" value="<?php echo $data[2] ?>">
                        </div>
                        <div class="form-group">
                            <label for="student_sex">性别</label>
                            <input type="text" class="form-control" id="student_sex" name="student_sex" value="<?php echo $data[3] ?>">
                        </div>
                        <div class="form-group">
                            <label for="student_class">班级</label>
                            <input type="text" class="form-control" id="student_class" name="student_class" value="<?php echo $data[4] ?>">
                        </div>
                        <div class="form-group">
                            <label for="student_phone">电话</label>
                            <input type="text" class="form-control" id="student_phone" name="student_phone" value="<?php echo $data[5] ?>">
                        </div>
...
<script>
    ...
    function AjaxSend() {
        $.ajax({
            url: 'php_api/student_modify.php',
            type: "POST",
            data: {
                "nid": <?php echo $data[0]?>,
