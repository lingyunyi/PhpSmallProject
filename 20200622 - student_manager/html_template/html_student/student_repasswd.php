            ...
            <ul class="user-menu">
                <li class="dropdown pull-right">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="../../php_api\pubic_api\logout_api.php"><span class="glyphicon glyphicon-log-out"></span>登出</a></li>
                    </ul>
                </li>
            </ul>
        </div>
...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
        <li ><a href="student_info.php"><span class="glyphicon glyphicon-tree-deciduous"></span>我的成绩</a></li>
        <li class="active"><a href="student_repasswd.php"><span class="glyphicon glyphicon-tree-deciduous"></span>修改密码</a></li>
                ...
                <div class="panel-body">
                    <section>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="login_account" name="login_account" value="<?php echo $grade ?>" disabled="disabled">
                        </div>
                        <div class="form-group">
