...
<div class="container">
    <section>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="login_name" placeholder="姓名" >
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label class="radio-inline">
                <input type="radio" name="inlineRadioOptions" id="inlineRadio1" grade="A" checked>学生注册
            </label>
            <label class="radio-inline">
                <input type="radio" name="inlineRadioOptions" id="inlineRadio2" grade="B">教师注册
            </label>
            <label class="radio-inline">
                <input type="radio" name="inlineRadioOptions" id="inlineRadio3" grade="C">管理注册
            </label>
        </div>
    <a href="index.php"><button type="submit" class="btn btn-default">登入页面</button></a>
        <button type="submit" class="btn btn-primary btn-lg" onclick="return AjaxSend();">确认注册</button>
    </section>
</div>
<script>
    ...
    function AjaxSend() {
        ...
        $.ajax({
            url: 'php_api/pubic_api/register_api.php',
            type: "POST",
            data: {
